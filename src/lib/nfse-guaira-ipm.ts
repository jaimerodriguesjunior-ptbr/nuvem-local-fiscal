...
export function normalizeGuairaIpmDraft(
  ...
  return {
    ...
    customerStreet: firstText(address.xLgr, address.logradouro, "Nao Informado"),
    customerNumber: firstText(address.nro, address.numero, "SN"),
    customerComplement: firstText(address.xCpl, address.complemento),
    customerDistrict: firstText(address.xBairro, address.bairro, "Centro"),
    customerCityCode: firstText(nationalAddress.cMun, address.codigo_municipio, config.tomCode),
    customerPostalCode: digitsOnly(firstText(nationalAddress.CEP, address.cep, "85980000")),
